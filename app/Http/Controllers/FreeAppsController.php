...
class FreeAppsController extends Controller
{
    public function newFreeApps(){
        $freeapps = FreeApps::all();
        if(count($freeapps) === 0){
...
//                $catid2 = explode('?', $catid2[1]);
            ...
            return view('newfreeapps_main',compact('freeapps', 'xmll'));

        }else{
            return view('newfreeapps_main', compact('freeapps'));
        }
    }
