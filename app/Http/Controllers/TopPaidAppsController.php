...
class TopPaidAppsController extends Controller
{
    public function topPaidApps(){
        $toppaidapps = TopPaidApps::all();
        if(count($toppaidapps) === 0){
            ...
            return view('toppaidapps_main',compact('toppaidapps', 'xmll'));

        }else{
            return view('toppaidapps_main', compact('toppaidapps'));
        }
    }
}
