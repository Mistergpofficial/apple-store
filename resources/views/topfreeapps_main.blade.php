...
<head>
    ...
    <title><?php echo config('siteconfig.topfreeapps_title') ?> - <?php echo config('siteconfig.site_title') ?></title>
    <meta name="description" content="<?php echo config('siteconfig.topfreeapps_title') ?> - <?php echo config('siteconfig.site_title') ?>" />
    ...
    <meta property="og:title" content="<?php echo config('siteconfig.topfreeapps_title') ?> - <?php config('siteconfig.site_title') ?>"/>
    <meta property="og:description" content="<?php echo config('siteconfig.topfreeapps_title') ?> - <?php echo config('siteconfig.site_title') ?>"/>
    <!-- CSS and Scripts -->
    ...
    <div class="container">
        ...
        <div class="pageresults">
            ...
            <ul class="page-itemlist">
                        <ul class="page-itemlist">
                            @if($topfreeapps->count() > 0)
                                @foreach($topfreeapps as $topfreeapp)
                            <li class="page-item">
                                <div class="pagethumb" data-toggle="tooltip" data-placement="top" title="{{ $topfreeapp->imname1 }}">
                                    <a href="{{ url('/app/' . $topfreeapp->musicid1[0] . '/' . cano($topfreeapp->imname1)) }}">
                                        <img data-src="{!! asset($topfreeapp->bigimage1) !!}" src="{!! asset('public/images/loading.svg') !!}" >
                                    </a>
                                </div>
                                <div class="info">
                                    <h3>
                                        <a href="{{ url('/app/' . $topfreeapp->musicid1[0] . '/' . cano($topfreeapp->imname1)) }}">{{ $topfreeapp->imname1 }}</a>
                                    </h3>
                                    <h4>{{ $topfreeapp->imartist1 }}</h4>
                                    <a class="genre" href="{{ url('/category/' . $topfreeapp->catid1[0] . '/' . cano($topfreeapp->label)) }}">{{ $topfreeapp->label }}</a>
                                    <span class="summary">{{ $topfreeapp->summary }}</span>
                                </div>
                            </li>
                                @endforeach
                        </ul>
